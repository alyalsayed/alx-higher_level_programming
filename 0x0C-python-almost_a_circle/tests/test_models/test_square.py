...
class TestSquare(unittest.TestCase):
    ...
    def test_new_square_creation_case_1(self):
        """ Test new square """
        new = Square(3)
    ...
    def test_new_square_creation_case_2(self):
    ...
    def test_incorrect_amount_props_case_2(self):
        """ Test error raise with no args passed """
        with self.assertRaises(TypeError):
            new_square = Square()

    def test_incorrect_amount_props_case_2(self):
        """ Test error raised if more args passed """
        with self.assertRaises(TypeError):
            new_square = Square(3, 3, 5, 5, 5)

    def test_access_private_props_case_1(self):
        """ Trying to access to a private attribute """
        new_square = Square(5)
        with self.assertRaises(AttributeError):
            new_square.__width

    def test_access_private_props_case_2(self):
        """ Trying to access to a private attribute """
        new_square = Square(5)
        with self.assertRaises(AttributeError):
            new_square.__height

    def test_access_private_attrs_case_3(self):
        """ Trying to access to a private attribute """
        new_square = Square(5)
        with self.assertRaises(AttributeError):
            new_square.__x

    def test_access_private_attrs_case_4(self):
        """ Trying to access to a private attribute """
        new_square = Square(5)
        with self.assertRaises(AttributeError):
            new_square.__y
    ...
    def test_valide_attrs(self):
        ...
        with self.assertRaises(TypeError):
            new_square = Square("2", 3, 4, 5)

    def test_valide_attrs_2(self):
        """ Trying to pass a string value """
        with self.assertRaises(TypeError):
            new_square = Square(4, "6", 7, 8)
    ...
    def test_value_attrs_3(self):
        """ Trying to pass invalid values """
        with self.assertRaises(ValueError):
            new_square = Square(1, 1, -1)

    def test_area(self):
        """ Checking the return value of area method """
        new_square = Square(4)
        self.assertEqual(new_square.area(), 16)
    ...
    def test_area_2(self):
        """ Checking the return value of area method """
        new_square = Square(2)
        self.assertEqual(new_square.area(), 4)
        new_square.size = 5
